  ...
  return (
    <Card className="overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 border-t px-4 py-2
        ...
        {answer.resources?.peakCpuPercent != null && (
          <>
            <span>CPU %{answer.resources.peakCpuPercent.toFixed(0)}</span>
            <span>RAM {formatRam(answer.resources.peakRamMb)}</span>
            <span>{formatGpu(answer.resources.gpuVramMb)}</span>
          </>
        )}
